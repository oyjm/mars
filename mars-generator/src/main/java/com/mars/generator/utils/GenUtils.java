package com.mars.generator.utils;

import com.mars.generator.entity.ColumnEntity;
import com.mars.generator.entity.TableEntity;
...
public class GenUtils {
	...
	public static void generatorCode(Map<String, String> table,
		...
		mainPath = StringUtils.isBlank(mainPath) ? "com.mars" : mainPath;
		...
		for(String template : templates){
			...
			try {
				...
				throw new MarsException("渲染模板失败，表名：" + tableEntity.getTableName(), e);
			}
		}
	}
	...
	public static Configuration getConfig(){
		try {
			...
			throw new MarsException("获取配置文件失败，", e);
		}
	}
